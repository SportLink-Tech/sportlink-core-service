...
import { CreateMatchOfferUseCase } from '../CreateMatchOfferUseCase'
...
describe('CreateMatchOfferUseCase', () => {
  let useCase: CreateMatchOfferUseCase

  beforeEach(() => {
    useCase = new CreateMatchOfferUseCase(mockRepository)
    vi.clearAllMocks()
  })

  const validRequest: CreateMatchOfferRequest = {
  ...
  const mockAnnouncement: MatchOffer = {
    id: '123',
    team_name: 'Boca Junior',
    sport: 'Paddle',
    day: '2025-12-05',
